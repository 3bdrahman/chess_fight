"""Centralized constants and configuration defaults for chess_fight.
...
DEFAULT_MOVE_TIMEOUT_SECONDS: int = 30
...
HOSTED_PROVIDERS: tuple[str, ...] | None = tuple(_env_providers.split(",")) if _env_providers else ("openrouter",)
